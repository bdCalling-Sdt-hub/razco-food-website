...
const Footer = () => {
  return (
    <div>
      {/* <!-- Footer container -->  */}
      <footer className="bg-[#70B446] text-center text-white  lg:text-left ">
        {/* <!-- Main container div: holds the entire content of the footer, including four sections (TW Elements, Products, Useful links, and Contact), with responsive styling and appropriate padding/margins. -->  */}
        <div className="mx-6 py-10 text-center md:text-left lg:ps-[270px] lg:pe-[270px]  ">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4 justify-items-center lg:pb-[80px] lg:pt-[20px]">
            {/* <!-- TW Elements section -->  */}
            <div className=" -mt-5 ">
        ...
        {/* <!--Copyright section-->  */}
        <div className="bg-black  p-3 text-center lg:ps-[270px] lg:pe-[270px] flex justify-between items-center">
