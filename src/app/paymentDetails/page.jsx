...
const page = () => {
  ...
  return (
    <div className=" lg:mt-12 lg:ms-[270px] lg:me-[250px] lg:mb-20  border-2 border-[#c5c2c2] lg:pb-14 lg:pt-14 rounded shadow-lg">
      <div className="  lg:w-[600px] mx-auto">
        ...
        <p className=" text-[#555656] mt-3 font-medium pb-3 lg:mt-20 text-lg ">
          {" "}
          Payment Option{" "}
        </p>
